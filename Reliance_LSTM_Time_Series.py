...
plt.legend()
plt.grid(True)
plt.savefig("reliance_actual_vs_predicted_detailed.png")
plt.show()

print("Graph saved as reliance_actual_vs_predicted_detailed.png")
...
plt.legend()
plt.grid(True)
plt.savefig("reliance_training_loss_detailed.png")
plt.show()

print("Graph saved as reliance_training_loss_detailed.png")
